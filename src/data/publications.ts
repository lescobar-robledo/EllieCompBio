...
export const publications: Publication[] = [
  ...
  {
    year: 2021,
    title: 'A novel method for the noninvasive estimation of cardiac output with brachial oscillometric blood pressure measurements through an assessment of arterial compliance',
    authors:
      'Álvarez-Montoya, D., Madrid-Muñoz, C., <strong>Escobar-Robledo, L.</strong>, Gallo-Villegas, J., & Aristizábal-Ocampo, D.',
  ...
  {
    year: 2018,
    title: 'Interatrial block and atrial remodeling assessed using speckle tracking echocardiography',
    authors: 'Lacalzada-Almeida, J., <strong>Escobar-Robledo, L. A.</strong>, et al.',
  ...
  },
  {
    ...
    authors: '<strong>Escobar-Robledo, L. A.</strong>, et al.',
  ...
  {
    year: 2018,
    title: 'Atypical advanced interatrial blocks: Definition and electrocardiographic recognition',
    authors: 'Bayés de Luna, A., <strong>Escobar-Robledo, L. A.</strong>, et al.',
    venue: 'Journal of Electrocardiology',
    volume: '51',
    issue: '6',
    pages: '1091–1093',
  ...
  {
    year: 2018,
    title: 'Interatrial block, frailty and prognosis in elderly patients with myocardial infarction',
    authors: 'Bernal, E., <strong>Escobar-Robledo, L. A.</strong>, et al.',
    venue: 'Journal of Electrocardiology',
    volume: '51',
    issue: '1',
    pages: '1–7',
  ...
  {
    year: 2018,
    title: 'Actualización de la muerte súbita cardiaca: epidemiología y estratificación del riesgo',
    authors: 'Bayés de Luna, A., <strong>Escobar-Robledo, L. A.</strong>, et al.',
  ...
  {
    year: 2018,
    title: 'Corrigendum to “Interatrial block, frailty and prognosis in elderly patients with myocardial infarction”',
    authors: 'Bernal, E., <strong>Escobar-Robledo, L. A.</strong>, et al.',
    venue: 'Journal of Electrocardiology',
    volume: '51',
    issue: '4',
  ...
  },
  {
    ...
    authors: 'Bayés de Luna, A., Baranchuk, A., <strong>Escobar-Robledo, L. A.</strong>, Massó-van Roessel, A., & Martínez-Sellés, M.',
  ...
  },
  {
    ...
    authors: 'Bayés de Luna, A., <strong>Escobar-Robledo, L. A.</strong>, & Massó-van Roessel, A.',
    venue: 'Cardiocore',
    volume: '52',
    issue: '3',
    pages: '91–98',
    link: 'https://www.elsevier.es/es-revista-cardiocore-209-articulo-la-onda-p-normal-patologica-S1889183717300458'
  },
  {
    year: 2017,
    title: 'Interatrial block and the risk of ischemic stroke',
    authors: 'Martínez-Sellés, M., <strong>Escobar-Robledo, L. A.</strong>, & Baranchuk, A.',
    venue: 'Journal of Atherosclerosis and Thrombosis',
    volume: '24',
    issue: '2',
    pages: '185–186',
    link: 'https://www.jstage.jst.go.jp/article/jat/24/2/24_39856/_article'
  },
  {
    year: 2017,
    title:
    ...
    authors: 'Massó-van Roessel, A., <strong>Escobar-Robledo, L. A.</strong>, et al.',
    venue: 'Revista Española de Cardiología (English Edition)',
    volume: '70',
    issue: '10',
    pages: '841–847',
  ...
  {
    year: 2015,
    title: 'The diagnosis and clinical implications of interatrial block',
    authors: 'Bayes de Luna, A., Massó-van Roessel, A., & <strong>Escobar-Robledo, L. A.</strong>',
...
export const bookChapters: Publication[] = [
  {
    ...
    authors: 'Bayés de Luna, A., Massó-van Roessel, A., & <strong>Escobar-Robledo, L. A.</strong>',
    venue:
